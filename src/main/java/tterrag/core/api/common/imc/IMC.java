...
public class IMC
{
     ...
     * <p>
     * The "reset meta" is the metadata that the plant will be reset to when it is harvested.
     * Regular meta is the meta that must match the plant in world for the harvest to occur.
     */
