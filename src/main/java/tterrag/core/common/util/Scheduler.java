...
public class Scheduler
{
     ...
     *            <p>
     *            You will get a different {@link TickEvent} depending on the side. <br>
     *            {@link Side#CLIENT} will be passed a {@link ClientTickEvent} <br>
     *            {@link Side#SERVER} will be passed a {@link ServerTickEvent}
     *            <p>
     *            Note: passing in {@link Side#CLIENT} on a dedicated server will work, but your
     *            task will never be called. Please avoid doing this to save processing.
     */
    ...
    /**
     * Returns the {@link Scheduler} instance for the current side. Please refer to
     * {@link Scheduler#schedule(int, Runnable, Side)} for sided scheduling information.
     * 
